...
This is an entrypoint that sets up a basic Bot with pycord.
...
It can be used to perform manual administrative actions as the bot, or to test pycord itself.
...
def entrypoint(intents: typing.Iterable[str], token: str):
    """
    Entrypoint accessible through `python -m pycord <TOKEN>`
    """
