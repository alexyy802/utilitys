...
from pycord.shim.paginator_base import EmojiSettings

# Version detection
if discord.version_info >= (2, 0, 0):
    from pycord.shim.paginator_200 import PaginatorEmbedInterface, PaginatorInterface
else:
    from pycord.shim.paginator_170 import PaginatorEmbedInterface, PaginatorInterface
