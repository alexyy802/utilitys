...
from pycord.repl import AsyncCodeExecutor, Scope, all_inspections, disassemble, get_var_dict_from_ctx
...
class PythonFeature(Feature):
    ...
    async def pyc_python_result_handling(self, ctx: commands.Context, result):  # pylint: disable=too-many-return-statements
        """
    ...
    @Feature.Command(parent="pyc", name="py_inspect", aliases=["pyi", "python_inspect", "pythoninspect"])
    async def pyc_python_inspect(self, ctx: commands.Context, *, argument: codeblock_converter):  # pylint: disable=too-many-locals
        """
    ...
    async def pyc_disassemble(self, ctx: commands.Context, *, argument: codeblock_converter):
        """
