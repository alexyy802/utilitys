...
Here are some ways to use our package in **your own bot!** For github based examples, see `the examples directory <https://github.com/pycord/utilitys/tree/master/examples>`_.
