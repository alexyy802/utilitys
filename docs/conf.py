...
extlinks = {
    'issue': ('https://github.com/pycord/utilitys/issues/%s', 'GH-'),
}
...
# html_favicon = './images/pycord-utils.ico'
...
man_pages = [
    ('index', 'pycord-utils', 'pycord-utils Documentation',
     ['Pycord'], 1)
]
...
texinfo_documents = [
  ('index', 'pycord-utilitys', 'pycord-utils Documentation',
   'Pycord', 'pycord-utils', 'One line description of project.',
   'Miscellaneous'),
]
